...
<!-- @head.03 . p -->
Entur er salgs- og distribusjonsinfrastrukturen for norsk kollektivtransport. Dette er et notat utarbeidet i forkant av møte med Vipps om ett konkret mål: et gjennomført agentkjøp av en norsk kollektivbillett før jul. Under følger våre betraktninger av hvor feltet står, hva vi tror et agentmandat kan kreve av en betalingsavtale, og spørsmålene vi trenger svar på for å komme dit. Første del tar rundt ni minutter å lese, og er det vi håper dere rekker før møtet. Resten ligger som underlag.
